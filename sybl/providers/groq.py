...
from sybl.config.models import GroqConfig
from sybl.config.vocabulary import build_groq_vocabulary_prompt
...
logger = logging.getLogger("sybl.providers.groq")
...
class GroqProvider:
    ...
    def _resolve_api_key(self) -> str:
        ...
        if not key:
            raise STTAuthError(
                "Groq API key not found. Run: sybl config set-key groq"
            )
        return key
