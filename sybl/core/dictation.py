...
from sybl.config.vocabulary import VocabularyStore
from sybl.core.postprocess import process_text
from sybl.core.state import SessionState, StateMachine
...
class DictationController:
    ...
    def update_config(self, config: SyblConfig) -> None:
        self._config = config
