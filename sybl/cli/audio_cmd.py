"""`sybl audio` — device listing and capture testing."""
...
from sybl.config import AudioConfig, ConfigManager, log_path
    ...
    try:
        asyncio.run(
            _record(
                ...
                save_path,
                no_save,
                sybl_config.audio.save_last_recording,
            )
        )
