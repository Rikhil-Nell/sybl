...
from navi.config.models import IndicatorConfig
from navi.indicator.cursor_win import clamp_to_screen, get_cursor_pos

logger = logging.getLogger("navi.indicator.tk")
