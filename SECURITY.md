...
- [GitHub Security Advisories](https://github.com/Rikhil-Nell/navi/security/advisories/new)
  (preferred)
...
Navi is a local-first BYOK dictation tool. API keys are stored in the OS keyring
